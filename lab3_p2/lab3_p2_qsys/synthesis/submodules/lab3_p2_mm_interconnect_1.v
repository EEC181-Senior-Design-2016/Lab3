...
`timescale 1 ps / 1 ps
module lab3_p2_mm_interconnect_1 (
	...
	wire  [113:0] pushbutton_s1_agent_rp_data;                                                 // pushbutton_s1_agent:rp_data -> router_004:sink_data
	...
	wire    [2:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> reg32_avalon_interface_0_avalon_slave_0_burst_adapter:sink0_channel
	...
	lab3_p2_mm_interconnect_1_router router (
	...
	lab3_p2_mm_interconnect_1_router router_001 (
	...
	lab3_p2_mm_interconnect_1_router_002 router_002 (
	...
	lab3_p2_mm_interconnect_1_router_002 router_003 (
	...
	lab3_p2_mm_interconnect_1_router_002 router_004 (
	...
	lab3_p2_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (sys_clk_sys_clk_clk),                                                 //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	lab3_p2_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (sys_clk_sys_clk_clk),                                                 //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	lab3_p2_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (sys_clk_sys_clk_clk),                                                 //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (sys_clk_sys_clk_clk),                                                 //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
