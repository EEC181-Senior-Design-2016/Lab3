...
`timescale 1 ps / 1 ps
module lab3_p2_mm_interconnect_0 (
	...
	lab3_p2_mm_interconnect_0_router router (
	...
	lab3_p2_mm_interconnect_0_router router_001 (
	...
	lab3_p2_mm_interconnect_0_router_002 router_002 (
	...
	lab3_p2_mm_interconnect_0_router_003 router_003 (
	...
	lab3_p2_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (sys_clk_sys_clk_clk),                                              //        clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	lab3_p2_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (sys_clk_sys_clk_clk),                                              //        clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	lab3_p2_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (sys_clk_sys_clk_clk),                                 //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (sys_clk_sys_clk_clk),                                 //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (sys_clk_sys_clk_clk),                                     //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),     // clk_reset.reset
	...
	lab3_p2_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (sys_clk_sys_clk_clk),                                 //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (sys_clk_sys_clk_clk),                                              //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (sys_clk_sys_clk_clk),                                              //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
