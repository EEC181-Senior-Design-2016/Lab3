// lab3_p1_qsys_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module lab3_p1_qsys_mm_interconnect_1 (
	...
	lab3_p1_qsys_mm_interconnect_1_router router (
	...
	lab3_p1_qsys_mm_interconnect_1_router router_001 (
	...
	lab3_p1_qsys_mm_interconnect_1_router_002 router_002 (
	...
	lab3_p1_qsys_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (sys_clk_sys_clk_clk),                                              //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p1_qsys_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (sys_clk_sys_clk_clk),                                              //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p1_qsys_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (sys_clk_sys_clk_clk),                                 //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p1_qsys_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (sys_clk_sys_clk_clk),                                     //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),     // clk_reset.reset
	...
	lab3_p1_qsys_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (sys_clk_sys_clk_clk),                                              //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p1_qsys_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (sys_clk_sys_clk_clk),                                              //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
