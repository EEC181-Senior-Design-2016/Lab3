// lab3_p2_qsys_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module lab3_p2_qsys_mm_interconnect_1 (
		...
		output wire [1:0]  done_input_s1_address,                                               //                                                 done_input_s1.address
		input  wire [31:0] done_input_s1_readdata,                                              //                                                              .readdata
		...
		output wire [1:0]  ready_output_s1_address,                                             //                                               ready_output_s1.address
		output wire        ready_output_s1_write,                                               //                                                              .write
		input  wire [31:0] ready_output_s1_readdata,                                            //                                                              .readdata
		output wire [31:0] ready_output_s1_writedata,                                           //                                                              .writedata
		output wire        ready_output_s1_chipselect                                           //                                                              .chipselect
	);
	...
	wire  [114:0] pushbutton_s1_agent_rf_source_data;                                // pushbutton_s1_agent:rf_source_data -> pushbutton_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] pushbutton_s1_agent_rsp_fifo_out_data;                             // pushbutton_s1_agent_rsp_fifo:out_data -> pushbutton_s1_agent:rf_sink_data
	...
	wire   [31:0] ready_output_s1_agent_m0_readdata;                                 // ready_output_s1_translator:uav_readdata -> ready_output_s1_agent:m0_readdata
	wire          ready_output_s1_agent_m0_waitrequest;                              // ready_output_s1_translator:uav_waitrequest -> ready_output_s1_agent:m0_waitrequest
	wire          ready_output_s1_agent_m0_debugaccess;                              // ready_output_s1_agent:m0_debugaccess -> ready_output_s1_translator:uav_debugaccess
	wire   [20:0] ready_output_s1_agent_m0_address;                                  // ready_output_s1_agent:m0_address -> ready_output_s1_translator:uav_address
	wire    [3:0] ready_output_s1_agent_m0_byteenable;                               // ready_output_s1_agent:m0_byteenable -> ready_output_s1_translator:uav_byteenable
	wire          ready_output_s1_agent_m0_read;                                     // ready_output_s1_agent:m0_read -> ready_output_s1_translator:uav_read
	wire          ready_output_s1_agent_m0_readdatavalid;                            // ready_output_s1_translator:uav_readdatavalid -> ready_output_s1_agent:m0_readdatavalid
	wire          ready_output_s1_agent_m0_lock;                                     // ready_output_s1_agent:m0_lock -> ready_output_s1_translator:uav_lock
	wire   [31:0] ready_output_s1_agent_m0_writedata;                                // ready_output_s1_agent:m0_writedata -> ready_output_s1_translator:uav_writedata
	wire          ready_output_s1_agent_m0_write;                                    // ready_output_s1_agent:m0_write -> ready_output_s1_translator:uav_write
	wire    [2:0] ready_output_s1_agent_m0_burstcount;                               // ready_output_s1_agent:m0_burstcount -> ready_output_s1_translator:uav_burstcount
	wire          ready_output_s1_agent_rf_source_valid;                             // ready_output_s1_agent:rf_source_valid -> ready_output_s1_agent_rsp_fifo:in_valid
	wire  [114:0] ready_output_s1_agent_rf_source_data;                              // ready_output_s1_agent:rf_source_data -> ready_output_s1_agent_rsp_fifo:in_data
	wire          ready_output_s1_agent_rf_source_ready;                             // ready_output_s1_agent_rsp_fifo:in_ready -> ready_output_s1_agent:rf_source_ready
	wire          ready_output_s1_agent_rf_source_startofpacket;                     // ready_output_s1_agent:rf_source_startofpacket -> ready_output_s1_agent_rsp_fifo:in_startofpacket
	wire          ready_output_s1_agent_rf_source_endofpacket;                       // ready_output_s1_agent:rf_source_endofpacket -> ready_output_s1_agent_rsp_fifo:in_endofpacket
	wire          ready_output_s1_agent_rsp_fifo_out_valid;                          // ready_output_s1_agent_rsp_fifo:out_valid -> ready_output_s1_agent:rf_sink_valid
	wire  [114:0] ready_output_s1_agent_rsp_fifo_out_data;                           // ready_output_s1_agent_rsp_fifo:out_data -> ready_output_s1_agent:rf_sink_data
	wire          ready_output_s1_agent_rsp_fifo_out_ready;                          // ready_output_s1_agent:rf_sink_ready -> ready_output_s1_agent_rsp_fifo:out_ready
	wire          ready_output_s1_agent_rsp_fifo_out_startofpacket;                  // ready_output_s1_agent_rsp_fifo:out_startofpacket -> ready_output_s1_agent:rf_sink_startofpacket
	wire          ready_output_s1_agent_rsp_fifo_out_endofpacket;                    // ready_output_s1_agent_rsp_fifo:out_endofpacket -> ready_output_s1_agent:rf_sink_endofpacket
	wire          ready_output_s1_agent_rdata_fifo_src_valid;                        // ready_output_s1_agent:rdata_fifo_src_valid -> ready_output_s1_agent_rdata_fifo:in_valid
	wire   [33:0] ready_output_s1_agent_rdata_fifo_src_data;                         // ready_output_s1_agent:rdata_fifo_src_data -> ready_output_s1_agent_rdata_fifo:in_data
	wire          ready_output_s1_agent_rdata_fifo_src_ready;                        // ready_output_s1_agent_rdata_fifo:in_ready -> ready_output_s1_agent:rdata_fifo_src_ready
	wire   [31:0] done_input_s1_agent_m0_readdata;                                   // done_input_s1_translator:uav_readdata -> done_input_s1_agent:m0_readdata
	wire          done_input_s1_agent_m0_waitrequest;                                // done_input_s1_translator:uav_waitrequest -> done_input_s1_agent:m0_waitrequest
	wire          done_input_s1_agent_m0_debugaccess;                                // done_input_s1_agent:m0_debugaccess -> done_input_s1_translator:uav_debugaccess
	wire   [20:0] done_input_s1_agent_m0_address;                                    // done_input_s1_agent:m0_address -> done_input_s1_translator:uav_address
	wire    [3:0] done_input_s1_agent_m0_byteenable;                                 // done_input_s1_agent:m0_byteenable -> done_input_s1_translator:uav_byteenable
	wire          done_input_s1_agent_m0_read;                                       // done_input_s1_agent:m0_read -> done_input_s1_translator:uav_read
	wire          done_input_s1_agent_m0_readdatavalid;                              // done_input_s1_translator:uav_readdatavalid -> done_input_s1_agent:m0_readdatavalid
	wire          done_input_s1_agent_m0_lock;                                       // done_input_s1_agent:m0_lock -> done_input_s1_translator:uav_lock
	wire   [31:0] done_input_s1_agent_m0_writedata;                                  // done_input_s1_agent:m0_writedata -> done_input_s1_translator:uav_writedata
	wire          done_input_s1_agent_m0_write;                                      // done_input_s1_agent:m0_write -> done_input_s1_translator:uav_write
	wire    [2:0] done_input_s1_agent_m0_burstcount;                                 // done_input_s1_agent:m0_burstcount -> done_input_s1_translator:uav_burstcount
	wire          done_input_s1_agent_rf_source_valid;                               // done_input_s1_agent:rf_source_valid -> done_input_s1_agent_rsp_fifo:in_valid
	wire  [114:0] done_input_s1_agent_rf_source_data;                                // done_input_s1_agent:rf_source_data -> done_input_s1_agent_rsp_fifo:in_data
	wire          done_input_s1_agent_rf_source_ready;                               // done_input_s1_agent_rsp_fifo:in_ready -> done_input_s1_agent:rf_source_ready
	wire          done_input_s1_agent_rf_source_startofpacket;                       // done_input_s1_agent:rf_source_startofpacket -> done_input_s1_agent_rsp_fifo:in_startofpacket
	wire          done_input_s1_agent_rf_source_endofpacket;                         // done_input_s1_agent:rf_source_endofpacket -> done_input_s1_agent_rsp_fifo:in_endofpacket
	wire          done_input_s1_agent_rsp_fifo_out_valid;                            // done_input_s1_agent_rsp_fifo:out_valid -> done_input_s1_agent:rf_sink_valid
	wire  [114:0] done_input_s1_agent_rsp_fifo_out_data;                             // done_input_s1_agent_rsp_fifo:out_data -> done_input_s1_agent:rf_sink_data
	wire          done_input_s1_agent_rsp_fifo_out_ready;                            // done_input_s1_agent:rf_sink_ready -> done_input_s1_agent_rsp_fifo:out_ready
	wire          done_input_s1_agent_rsp_fifo_out_startofpacket;                    // done_input_s1_agent_rsp_fifo:out_startofpacket -> done_input_s1_agent:rf_sink_startofpacket
	wire          done_input_s1_agent_rsp_fifo_out_endofpacket;                      // done_input_s1_agent_rsp_fifo:out_endofpacket -> done_input_s1_agent:rf_sink_endofpacket
	wire          done_input_s1_agent_rdata_fifo_src_valid;                          // done_input_s1_agent:rdata_fifo_src_valid -> done_input_s1_agent_rdata_fifo:in_valid
	wire   [33:0] done_input_s1_agent_rdata_fifo_src_data;                           // done_input_s1_agent:rdata_fifo_src_data -> done_input_s1_agent_rdata_fifo:in_data
	wire          done_input_s1_agent_rdata_fifo_src_ready;                          // done_input_s1_agent_rdata_fifo:in_ready -> done_input_s1_agent:rdata_fifo_src_ready
	...
	wire  [113:0] pushbutton_s1_agent_rp_data;                                       // pushbutton_s1_agent:rp_data -> router_003:sink_data
	...
	wire          ready_output_s1_agent_rp_valid;                                    // ready_output_s1_agent:rp_valid -> router_004:sink_valid
	wire  [113:0] ready_output_s1_agent_rp_data;                                     // ready_output_s1_agent:rp_data -> router_004:sink_data
	wire          ready_output_s1_agent_rp_ready;                                    // router_004:sink_ready -> ready_output_s1_agent:rp_ready
	wire          ready_output_s1_agent_rp_startofpacket;                            // ready_output_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          ready_output_s1_agent_rp_endofpacket;                              // ready_output_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          done_input_s1_agent_rp_valid;                                      // done_input_s1_agent:rp_valid -> router_005:sink_valid
	wire  [113:0] done_input_s1_agent_rp_data;                                       // done_input_s1_agent:rp_data -> router_005:sink_data
	wire          done_input_s1_agent_rp_ready;                                      // router_005:sink_ready -> done_input_s1_agent:rp_ready
	wire          done_input_s1_agent_rp_startofpacket;                              // done_input_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          done_input_s1_agent_rp_endofpacket;                                // done_input_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [113:0] cmd_mux_001_src_data;                                              // cmd_mux_001:src_data -> pushbutton_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                             // pushbutton_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                           // cmd_mux_001:src_channel -> pushbutton_s1_burst_adapter:sink0_channel
	...
	wire  [113:0] pushbutton_s1_burst_adapter_source0_data;                          // pushbutton_s1_burst_adapter:source0_data -> pushbutton_s1_agent:cp_data
	wire          pushbutton_s1_burst_adapter_source0_ready;                         // pushbutton_s1_agent:cp_ready -> pushbutton_s1_burst_adapter:source0_ready
	wire    [3:0] pushbutton_s1_burst_adapter_source0_channel;                       // pushbutton_s1_burst_adapter:source0_channel -> pushbutton_s1_agent:cp_channel
	...
	wire          cmd_mux_002_src_valid;                                             // cmd_mux_002:src_valid -> ready_output_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_002_src_data;                                              // cmd_mux_002:src_data -> ready_output_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                             // ready_output_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                           // cmd_mux_002:src_channel -> ready_output_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                     // cmd_mux_002:src_startofpacket -> ready_output_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                       // cmd_mux_002:src_endofpacket -> ready_output_s1_burst_adapter:sink0_endofpacket
	wire          ready_output_s1_burst_adapter_source0_valid;                       // ready_output_s1_burst_adapter:source0_valid -> ready_output_s1_agent:cp_valid
	wire  [113:0] ready_output_s1_burst_adapter_source0_data;                        // ready_output_s1_burst_adapter:source0_data -> ready_output_s1_agent:cp_data
	wire          ready_output_s1_burst_adapter_source0_ready;                       // ready_output_s1_agent:cp_ready -> ready_output_s1_burst_adapter:source0_ready
	wire    [3:0] ready_output_s1_burst_adapter_source0_channel;                     // ready_output_s1_burst_adapter:source0_channel -> ready_output_s1_agent:cp_channel
	wire          ready_output_s1_burst_adapter_source0_startofpacket;               // ready_output_s1_burst_adapter:source0_startofpacket -> ready_output_s1_agent:cp_startofpacket
	wire          ready_output_s1_burst_adapter_source0_endofpacket;                 // ready_output_s1_burst_adapter:source0_endofpacket -> ready_output_s1_agent:cp_endofpacket
	wire          cmd_mux_003_src_valid;                                             // cmd_mux_003:src_valid -> done_input_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_003_src_data;                                              // cmd_mux_003:src_data -> done_input_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                             // done_input_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                           // cmd_mux_003:src_channel -> done_input_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                     // cmd_mux_003:src_startofpacket -> done_input_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                       // cmd_mux_003:src_endofpacket -> done_input_s1_burst_adapter:sink0_endofpacket
	wire          done_input_s1_burst_adapter_source0_valid;                         // done_input_s1_burst_adapter:source0_valid -> done_input_s1_agent:cp_valid
	wire  [113:0] done_input_s1_burst_adapter_source0_data;                          // done_input_s1_burst_adapter:source0_data -> done_input_s1_agent:cp_data
	wire          done_input_s1_burst_adapter_source0_ready;                         // done_input_s1_agent:cp_ready -> done_input_s1_burst_adapter:source0_ready
	wire    [3:0] done_input_s1_burst_adapter_source0_channel;                       // done_input_s1_burst_adapter:source0_channel -> done_input_s1_agent:cp_channel
	wire          done_input_s1_burst_adapter_source0_startofpacket;                 // done_input_s1_burst_adapter:source0_startofpacket -> done_input_s1_agent:cp_startofpacket
	wire          done_input_s1_burst_adapter_source0_endofpacket;                   // done_input_s1_burst_adapter:source0_endofpacket -> done_input_s1_agent:cp_endofpacket
	...
	wire          ready_output_s1_agent_rdata_fifo_out_valid;                        // ready_output_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] ready_output_s1_agent_rdata_fifo_out_data;                         // ready_output_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          ready_output_s1_agent_rdata_fifo_out_ready;                        // avalon_st_adapter_002:in_0_ready -> ready_output_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                                 // avalon_st_adapter_002:out_0_valid -> ready_output_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                  // avalon_st_adapter_002:out_0_data -> ready_output_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                 // ready_output_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                 // avalon_st_adapter_002:out_0_error -> ready_output_s1_agent:rdata_fifo_sink_error
	wire          done_input_s1_agent_rdata_fifo_out_valid;                          // done_input_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] done_input_s1_agent_rdata_fifo_out_data;                           // done_input_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          done_input_s1_agent_rdata_fifo_out_ready;                          // avalon_st_adapter_003:in_0_ready -> done_input_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                                 // avalon_st_adapter_003:out_0_valid -> done_input_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                  // avalon_st_adapter_003:out_0_data -> done_input_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                 // done_input_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                 // avalon_st_adapter_003:out_0_error -> done_input_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) ready_output_s1_translator (
		.clk                    (sys_clk_sys_clk_clk),                           //                      clk.clk
		.reset                  (jtag_uart_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (ready_output_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (ready_output_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (ready_output_s1_agent_m0_read),                 //                         .read
		.uav_write              (ready_output_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (ready_output_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (ready_output_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (ready_output_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (ready_output_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (ready_output_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (ready_output_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (ready_output_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (ready_output_s1_address),                       //      avalon_anti_slave_0.address
		.av_write               (ready_output_s1_write),                         //                         .write
		.av_readdata            (ready_output_s1_readdata),                      //                         .readdata
		.av_writedata           (ready_output_s1_writedata),                     //                         .writedata
		.av_chipselect          (ready_output_s1_chipselect),                    //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) done_input_s1_translator (
		.clk                    (sys_clk_sys_clk_clk),                           //                      clk.clk
		.reset                  (jtag_uart_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (done_input_s1_agent_m0_address),                // avalon_universal_slave_0.address
		.uav_burstcount         (done_input_s1_agent_m0_burstcount),             //                         .burstcount
		.uav_read               (done_input_s1_agent_m0_read),                   //                         .read
		.uav_write              (done_input_s1_agent_m0_write),                  //                         .write
		.uav_waitrequest        (done_input_s1_agent_m0_waitrequest),            //                         .waitrequest
		.uav_readdatavalid      (done_input_s1_agent_m0_readdatavalid),          //                         .readdatavalid
		.uav_byteenable         (done_input_s1_agent_m0_byteenable),             //                         .byteenable
		.uav_readdata           (done_input_s1_agent_m0_readdata),               //                         .readdata
		.uav_writedata          (done_input_s1_agent_m0_writedata),              //                         .writedata
		.uav_lock               (done_input_s1_agent_m0_lock),                   //                         .lock
		.uav_debugaccess        (done_input_s1_agent_m0_debugaccess),            //                         .debugaccess
		.av_address             (done_input_s1_address),                         //      avalon_anti_slave_0.address
		.av_readdata            (done_input_s1_readdata),                        //                         .readdata
		.av_write               (),                                              //              (terminated)
		.av_read                (),                                              //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) ready_output_s1_agent (
		.clk                     (sys_clk_sys_clk_clk),                                 //             clk.clk
		.reset                   (jtag_uart_0_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (ready_output_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (ready_output_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (ready_output_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (ready_output_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (ready_output_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (ready_output_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (ready_output_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (ready_output_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (ready_output_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (ready_output_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (ready_output_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (ready_output_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (ready_output_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (ready_output_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (ready_output_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (ready_output_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (ready_output_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (ready_output_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (ready_output_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (ready_output_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (ready_output_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (ready_output_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (ready_output_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (ready_output_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (ready_output_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (ready_output_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (ready_output_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (ready_output_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (ready_output_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (ready_output_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (ready_output_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (ready_output_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (ready_output_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (ready_output_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (ready_output_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ready_output_s1_agent_rsp_fifo (
		.clk               (sys_clk_sys_clk_clk),                              //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (ready_output_s1_agent_rf_source_data),             //        in.data
		.in_valid          (ready_output_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (ready_output_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (ready_output_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (ready_output_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (ready_output_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (ready_output_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (ready_output_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (ready_output_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (ready_output_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ready_output_s1_agent_rdata_fifo (
		.clk               (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (ready_output_s1_agent_rdata_fifo_src_data),     //        in.data
		.in_valid          (ready_output_s1_agent_rdata_fifo_src_valid),    //          .valid
		.in_ready          (ready_output_s1_agent_rdata_fifo_src_ready),    //          .ready
		.out_data          (ready_output_s1_agent_rdata_fifo_out_data),     //       out.data
		.out_valid         (ready_output_s1_agent_rdata_fifo_out_valid),    //          .valid
		.out_ready         (ready_output_s1_agent_rdata_fifo_out_ready),    //          .ready
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (sys_clk_sys_clk_clk),                               //             clk.clk
		.reset                   (jtag_uart_0_reset_reset_bridge_in_reset_reset),     //       clk_reset.reset
		.m0_address              (done_input_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (done_input_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (done_input_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (done_input_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (done_input_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (done_input_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (done_input_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (done_input_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (done_input_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (done_input_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (done_input_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (done_input_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (done_input_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (done_input_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (done_input_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (done_input_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (done_input_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (done_input_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (done_input_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (done_input_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (done_input_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (done_input_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (done_input_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (done_input_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (done_input_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (done_input_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (done_input_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (done_input_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (done_input_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (done_input_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (done_input_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (done_input_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                 //                .error
		.rdata_fifo_src_ready    (done_input_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (done_input_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (done_input_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) done_input_s1_agent_rsp_fifo (
		.clk               (sys_clk_sys_clk_clk),                            //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
		.in_data           (done_input_s1_agent_rf_source_data),             //        in.data
		.in_valid          (done_input_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (done_input_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (done_input_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (done_input_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (done_input_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (done_input_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (done_input_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (done_input_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (done_input_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) done_input_s1_agent_rdata_fifo (
		.clk               (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (done_input_s1_agent_rdata_fifo_src_data),       //        in.data
		.in_valid          (done_input_s1_agent_rdata_fifo_src_valid),      //          .valid
		.in_ready          (done_input_s1_agent_rdata_fifo_src_ready),      //          .ready
		.out_data          (done_input_s1_agent_rdata_fifo_out_data),       //       out.data
		.out_valid         (done_input_s1_agent_rdata_fifo_out_valid),      //          .valid
		.out_ready         (done_input_s1_agent_rdata_fifo_out_ready),      //          .ready
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	lab3_p2_qsys_mm_interconnect_1_router router (
	...
	lab3_p2_qsys_mm_interconnect_1_router router_001 (
	...
	lab3_p2_qsys_mm_interconnect_1_router_002 router_002 (
	...
	lab3_p2_qsys_mm_interconnect_1_router_002 router_003 (
	...
	lab3_p2_qsys_mm_interconnect_1_router_002 router_004 (
		.sink_ready         (ready_output_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (ready_output_s1_agent_rp_valid),                //          .valid
		.sink_data          (ready_output_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (ready_output_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (ready_output_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_1_router_002 router_005 (
		.sink_ready         (done_input_s1_agent_rp_ready),                  //      sink.ready
		.sink_valid         (done_input_s1_agent_rp_valid),                  //          .valid
		.sink_data          (done_input_s1_agent_rp_data),                   //          .data
		.sink_startofpacket (done_input_s1_agent_rp_startofpacket),          //          .startofpacket
		.sink_endofpacket   (done_input_s1_agent_rp_endofpacket),            //          .endofpacket
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (ready_output_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (ready_output_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (ready_output_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (ready_output_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (ready_output_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (ready_output_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (done_input_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (done_input_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (done_input_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (done_input_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (done_input_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (done_input_s1_burst_adapter_source0_ready)          //          .ready
	);

	lab3_p2_qsys_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (sys_clk_sys_clk_clk),                                                 //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (sys_clk_sys_clk_clk),                                                 //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_1_rsp_demux rsp_demux_003 (
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (sys_clk_sys_clk_clk),                                                 //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (sys_clk_sys_clk_clk),                                                 //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab3_p2_qsys_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	lab3_p2_qsys_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (sys_clk_sys_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (ready_output_s1_agent_rdata_fifo_out_data),     //     in_0.data
		.in_0_valid     (ready_output_s1_agent_rdata_fifo_out_valid),    //         .valid
		.in_0_ready     (ready_output_s1_agent_rdata_fifo_out_ready),    //         .ready
	...
	lab3_p2_qsys_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (sys_clk_sys_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (done_input_s1_agent_rdata_fifo_out_data),       //     in_0.data
		.in_0_valid     (done_input_s1_agent_rdata_fifo_out_valid),      //         .valid
		.in_0_ready     (done_input_s1_agent_rdata_fifo_out_ready),      //         .ready
